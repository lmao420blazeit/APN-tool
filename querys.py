...
def query_generator(matnrs): 
        ...
        for _sys in sap_machine_list:
                ...
                new_query2 = """
                        SELECT 
                                EQUK.MATNR || EQUK.WERKS as LookupKey,
                                EQUK.WERKS as Plant,
                                EQUK.MATNR as "Material Number",
                                EQUP.QUOTE as Quote,
                                EKKO.ZTERM as "Payment Terms",
                                EKPO.MATKL as N10A,
                                EKKO.LIFNR as "SAP Supplier plant",
                                LFA1.NAME1 as Supplier,
                                EKKO.INCO1 as Incoterms,
                                EQUP.SOBES as Consignment,
